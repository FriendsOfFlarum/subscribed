...
!(function webpackMissingModule() { var e = new Error("Cannot find module 'flagrow/subscribed/notifications/DiscussionCreatedNotification'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module 'flagrow/subscribed/notifications/UserCreatedNotification'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());




app.initializers.add('flagrow-subscribed', function (app) {
  app.notificationComponents.discussionCreated = !(function webpackMissingModule() { var e = new Error("Cannot find module 'flagrow/subscribed/notifications/DiscussionCreatedNotification'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
  app.notificationComponents.userCreated = !(function webpackMissingModule() { var e = new Error("Cannot find module 'flagrow/subscribed/notifications/UserCreatedNotification'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
